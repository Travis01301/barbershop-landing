...
export default function SignUp() {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-50 via-white to-slate-50 p-4">
        <div className="max-w-md w-full bg-white p-10 rounded-2xl shadow-xl text-center border border-slate-200">
          ...
          <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg mb-6">
            <p className="text-sm text-blue-700 font-semibold">Check your email for confirmation</p>
          </div>
          <a href="/" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-lg font-bold transition-all shadow-md transform hover:-translate-y-0.5">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 py-12 px-4 flex items-center">
      <div className="max-w-md w-full mx-auto bg-white p-10 rounded-2xl shadow-xl border border-slate-200">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Start Free Trial</h1>
          <p className="text-slate-600 text-lg">7 days free, no credit card needed</p>
        </div>
        
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-bold text-slate-900 mb-2 uppercase tracking-wide">Shop Name *</label>
            <input
              type="text"
              required
              disabled={loading}
          ...
          <div>
            <label className="block text-sm font-bold text-slate-900 mb-2 uppercase tracking-wide">Your Name *</label>
            <input
              type="text"
              required
              disabled={loading}
          ...
          <div>
            <label className="block text-sm font-bold text-slate-900 mb-2 uppercase tracking-wide">Phone *</label>
            <input
              type="tel"
              required
              disabled={loading}
